...
java  -XX:+UseLargePages -d64 -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -verbose:gc -Xms2g -Xmx2g  -Dcom.tc.productkey.path=${TC_LICENSE_KEY} -cp ${PERF_CLASSPATH} com.terracotta.sample.FileUpload2Cache data.csv
